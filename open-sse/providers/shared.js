...
export const CLAUDE_CLI_SPOOF_HEADERS = {
  "Anthropic-Version": ANTHROPIC_API_VERSION,
  // omit context-management-2025-06-27: subscription-gated by Anthropic and breaks non-long-context models (e.g. Haiku). Real CLI clients still get it via claudeHeaderCache.
