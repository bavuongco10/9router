import { buildModelsList, applyRuleFilter } from "../route.js";
...
export async function GET(request, { params }) {
  try {
    ...
    if (kindFilter) {
      ...
      return json({ object: "list", data: out });
    }
    ...
    const allowed = await applyRuleFilter(request, models);
    const matchedModel = allowed.find((candidate) => candidate.id === identifier);
