...
export async function handleChat(request, clientRawRequest = null) {
  ...
  const comboModels = await getComboModels(modelStr, log);
  if (comboModels) {
    ...
    if (comboStrategy === "fusion") {
      ...
      return handleFusionChat({
        ...
        handleSingleModel: (b, m, isPanel) => {
          ...
          return handleSingleModelChat(b, m, cleanRawReq, request, apiKey, enforceRules, keyRule);
        },
        log,
        comboName: modelStr,
    ...
    return handleComboChat({
      ...
      handleSingleModel: withCapacityAdapterStripping(
        (b, m) => handleSingleModelChat(b, m, clientRawRequest, request, apiKey, enforceRules, keyRule),
        adapterAdded
      ),
      log,
      comboName: modelStr,
